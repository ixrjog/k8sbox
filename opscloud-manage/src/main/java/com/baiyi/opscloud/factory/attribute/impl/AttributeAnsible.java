...
public class AttributeAnsible extends AttributeBase {
     ...
     * 清空缓存
     */
    @CacheEvict(cacheNames = CachingConfig.DEFAULT_CACHE_REPO, key = "'preview_' + #serverGroupId", beforeInvocation = true)
     ...
     * @return
     */
    @Cacheable(cacheNames = CachingConfig.DEFAULT_CACHE_REPO, key = "'preview_' + #serverGroupId")
     ...
     * 清空缓存
     */
    @CacheEvict(cacheNames = CachingConfig.DEFAULT_CACHE_REPO, key = "'build_' + #ocServerGroup.id", beforeInvocation = true)
    public void evictBuild(OcServerGroup ocServerGroup) {
    }

    @Cacheable(cacheNames = CachingConfig.DEFAULT_CACHE_REPO, key = "'build_' + #ocServerGroup.id")
     ...
     * @param ocServerGroup
     */
    @CacheEvict(cacheNames = CachingConfig.DEFAULT_CACHE_REPO, key = "#ocServerGroup.id", beforeInvocation = true)
     ...
     * @return
     */
    @Cacheable(cacheNames = CachingConfig.DEFAULT_CACHE_REPO, key = "#ocServerGroup.id")
